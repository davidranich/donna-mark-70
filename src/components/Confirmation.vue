<template>
    <div class="p-6 max-w-2xl mx-auto text-center">
      <h1 style="" class="text-2xl font-bold mb-4">You're in the books!</h1>
      <div class="mb-4">
        <h2 class="text-lg font-semibold">Surprise 70th Birthday Party</h2>
        <p><a :href="mapLink" target="_blank" rel="noopener" class="map-link">Knights of Columbus, 25003 Little Mack Ave, St Clair Shores, MI 48080</a></p>
